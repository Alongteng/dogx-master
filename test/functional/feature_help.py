...
"""Verify that starting dogxcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dogxcoin with -h for help text")
        ...
        self.log.info("Start dogxcoin with -version for version information")
        ...
        self.log.info("Start dogxcoind with -fakearg to make sure it does not start")

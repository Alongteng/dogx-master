...
BITCOIND=${BITCOIND:-$BINDIR/dogxcoind}
BITCOINCLI=${BITCOINCLI:-$BINDIR/dogxcoin-cli}
BITCOINTX=${BITCOINTX:-$BINDIR/dogxcoin-tx}
BITCOINQT=${BITCOINQT:-$BINDIR/qt/dogxcoin-qt}

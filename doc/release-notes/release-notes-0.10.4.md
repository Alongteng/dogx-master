Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://dogxcoin.org/bin/dogxcoin-core-0.10.4/>
...
- #6953 `43c2789` Split dogxcoin-tx into its own package
- #6953 `dfe0d4d` Include dogxcoin-tx binary on Debian/Ubuntu

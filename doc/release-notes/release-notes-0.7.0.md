Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/dogxcoin/files/Bitcoin/dogxcoin-0.7.0/

We recommend that everybody running prior versions of dogxcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/dogxcoin/dogxcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/dogxcoin/dogxcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the dogxcoin-qt package:
  sudo apt-get install dogxcoin-qt
...
Core dogxcoin handling and blockchain database
...
* Ensure a changed dogxcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for dogxcoin-qt.exe
* (Windows only): add meta-data to dogxcoin-qt.exe (e.g. description)
...
* Bash programmable completion for dogxcoind(1)

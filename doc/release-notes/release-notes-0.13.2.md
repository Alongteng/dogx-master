Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://dogxcoin.org/bin/dogxcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update dogxcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow dogxcoin-tx to create v2 transactions (dogxdrak)

Bitcoin Core version 0.16.1 is now available from:
  ...
  <https://dogxcoincore.org/bin/dogxcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting dogxcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure dogxcoind processes are cleaned up when tests end (sdaftuar)

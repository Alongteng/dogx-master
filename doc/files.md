...
* dogxcoin.conf: contains configuration settings for dogxcoind or dogxcoin-qt
* dogxcoind.pid: stores the process id of dogxcoind while running
...
* debug.log: contains debug information and general logging generated by dogxcoind or dogxcoin-qt

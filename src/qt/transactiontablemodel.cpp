...
{
    QString str = BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->dedogx, false, separators);
    if(showUnconfirmed)
    {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::EditRole:
        ...
        case Amount:
            return qint64(rec->credit + rec->dedogx);
        }
        break;
    case Qt::ToolTipRole:
    ...
    case Qt::ForegroundRole:
        ...
        if(index.column() == Amount && (rec->credit+rec->dedogx) < 0)
        {

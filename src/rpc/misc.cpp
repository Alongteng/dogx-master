    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given dogxcoin address.\n"
                ...
                .ToString() +
            "\nArguments:\n"
            "1. \"address\"                    (string, required) The dogxcoin address to validate\n"
            "\nResult:\n"
            "{\n"
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                .ToString() +
            "\nArguments:\n"
            "1. \"address\"         (string, required) The dogxcoin address to use for the signature.\n"
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "dogxcoin-cli and the GUI. There is no server-side difference.",
                {}}
                .ToString() +
            "");

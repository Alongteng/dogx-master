Bitcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/dogxcoin/files/Bitcoin/dogxcoin-0.8.4/
...
code, causing the Bitcoin-Qt or dogxcoind process to crash.
Bloom filters were introduced with version 0.8, so versions 0.8.0
through 0.8.3 are vulnerable to this critical denial-of-service attack.

A constant-time algorithm is now used to check RPC password
guess attempts; fixes https://github.com/dogxcoin/dogxcoin/issues/2838
(CVE-2013-4165)

Implement a better fix for the fill-memory-with-orphan-transactions
attack that was fixed in 0.8.3. See
https://dogxslog.wordpress.com/2013/07/18/buggy-cve-2013-4627-patch-open-new-vectors-of-attack/
...
Linux: clicking on dogxcoin: links was broken if you were using
